  ...
  // Let's initialize the tables used, and greate a test user.
	...
	if (!$result) {
     die("Error in SQL query: " . pg_last_error());
  	...
  	$init = "CREATE TABLE IF NOT EXISTS tasks (id integer PRIMARY KEY, title VARCHAR(40) NOT NULL, 
	...
	$sql = "INSERT INTO users VALUES ('Mark', '1234', 'normal')";
	...
	$sql = "INSERT INTO users VALUES ('Lisa', 'abcd', 'normal')";
	$result = pg_query($database, $sql);
